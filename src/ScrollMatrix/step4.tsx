...
d3.selectAll('.hundred-prison-pop-body').attr("opacity", 1).transition().attr("opacity", 0).remove()
d3.selectAll('.hundred-prison-pop-head').attr("opacity", 1).transition().attr("opacity", 0).remove()
