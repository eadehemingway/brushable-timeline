export const data = [
  {
    ...
    description: `Grants freedom to all americans accept those being punished for a crime. Approximately 4 million saves freed in America`,
    level: 1,
  },
  {
    startYear: 1865,
    ...
    description: `The loophole in the ammendment allowing the incarceration as a form of punishment was immediately exploited. 
  ...
  },
  {
    ...
    description: `Laws that enforced racial segregation as well as preventing black people from voting.`,
    level: 1,
  },
  {
    startYear: 1915,
    ...
    description: `One of the first big blockbuster films. Painted the picture of the civil war that the whites wanted to see.
  ...
  },
  {
    ...
    description: `The Birth of a Nation led to a wave of terrorism. Lynchings rose and thousands of African 
  ...
  {
    startYear: 1986, // generally in the 80's
    endYear: 1989,
  ...
  {
    startYear: 1989, // not sure hwen but in general period before next election in 1993?
    endYear: 1993,
